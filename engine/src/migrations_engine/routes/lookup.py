...
router = APIRouter(prefix="/projects", tags=["lookup"])


@router.get(
    "/{project_id}/sources/{source_definition_id}/lookup-maps",
    response_model=list[LookupValueMapResponse],
)
...
@router.post(
    "/{project_id}/sources/{source_definition_id}/lookup-snapshots",
...
@router.post(
    "/{project_id}/sources/{source_definition_id}/lookup-snapshots/{lookup_snapshot_id}/approve",
    response_model=LookupSnapshotResponse,
)
