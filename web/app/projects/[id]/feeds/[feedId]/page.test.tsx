...
const {
  ...
  analyzeFeedSourceMock: vi.fn(() => Promise.resolve({ status: "completed", schemaArtifactId: "schema-1", destinationDDL: null })),
  getSourceSchemaArtifactMock: vi.fn(() => Promise.resolve({ schemaArtifactId: "schema-1", destinationDDL: null })),
...
vi.mock("../../../../../lib/feeds-api", () => ({
  ...
  getSourceSchemaArtifact: getSourceSchemaArtifactMock,
