...
| [002i3-multi-table-codegen-loop](./002i3-multi-table-codegen-loop.md) | Enable `build_delivery_bundle_text` for multiple artifacts + `generate_codegen_artifact` multi-table loop |
